...
impl GameState {
    fn init() -> GameState {
        GameState {_is_running: true, moves: vec![] }
    }
    ...
    fn perform_move(&mut self, chess_move: Move) -> Result<(), String> {
        ...
        let piece = board.get_piece(chess_move.tile_from)
    ...
    match piece {
        TeamedChessPiece(team, ChessPiece::Pawn) => {
            ...
            if starting_position_y == tile_from_coord.y &&
               coord_distance.y == 2 * team_factor && coord_distance.x == 0 {

                //check if there is a piece in the way(gotta check 2 squares)
                let piece_option = board.get_piece(Tile::try_from(
                        Coord{x:tile_from_coord.x, y: tile_from_coord.y + team_factor}).unwrap());
...
impl Board {
    fn start_position() -> Board {
        ...
        piece_locations.insert(Tile::A1, TeamedChessPiece(ChessTeam::White, ChessPiece::Rook));
        piece_locations.insert(Tile::B1, TeamedChessPiece(ChessTeam::White, ChessPiece::Knight));
        piece_locations.insert(Tile::C1, TeamedChessPiece(ChessTeam::White, ChessPiece::Bishop));
        piece_locations.insert(Tile::D1, TeamedChessPiece(ChessTeam::White, ChessPiece::Queen));
        piece_locations.insert(Tile::E1, TeamedChessPiece(ChessTeam::White, ChessPiece::King));
        piece_locations.insert(Tile::F1, TeamedChessPiece(ChessTeam::White, ChessPiece::Bishop));
        piece_locations.insert(Tile::G1, TeamedChessPiece(ChessTeam::White, ChessPiece::Knight));
        piece_locations.insert(Tile::H1, TeamedChessPiece(ChessTeam::White, ChessPiece::Rook));

        piece_locations.insert(Tile::A2, TeamedChessPiece(ChessTeam::White, ChessPiece::Pawn));
        piece_locations.insert(Tile::B2, TeamedChessPiece(ChessTeam::White, ChessPiece::Pawn));
        piece_locations.insert(Tile::C2, TeamedChessPiece(ChessTeam::White, ChessPiece::Pawn));
        piece_locations.insert(Tile::D2, TeamedChessPiece(ChessTeam::White, ChessPiece::Pawn));
        piece_locations.insert(Tile::E2, TeamedChessPiece(ChessTeam::White, ChessPiece::Pawn));
        piece_locations.insert(Tile::F2, TeamedChessPiece(ChessTeam::White, ChessPiece::Pawn));
        piece_locations.insert(Tile::G2, TeamedChessPiece(ChessTeam::White, ChessPiece::Pawn));
        piece_locations.insert(Tile::H2, TeamedChessPiece(ChessTeam::White, ChessPiece::Pawn));

        piece_locations.insert(Tile::A8, TeamedChessPiece(ChessTeam::Black, ChessPiece::Rook));
        piece_locations.insert(Tile::B8, TeamedChessPiece(ChessTeam::Black, ChessPiece::Knight));
        piece_locations.insert(Tile::C8, TeamedChessPiece(ChessTeam::Black, ChessPiece::Bishop));
        piece_locations.insert(Tile::D8, TeamedChessPiece(ChessTeam::Black, ChessPiece::Queen));
        piece_locations.insert(Tile::E8, TeamedChessPiece(ChessTeam::Black, ChessPiece::King));
        piece_locations.insert(Tile::F8, TeamedChessPiece(ChessTeam::Black, ChessPiece::Bishop));
        piece_locations.insert(Tile::G8, TeamedChessPiece(ChessTeam::Black, ChessPiece::Knight));
        piece_locations.insert(Tile::H8, TeamedChessPiece(ChessTeam::Black, ChessPiece::Rook));

        piece_locations.insert(Tile::A7, TeamedChessPiece(ChessTeam::Black, ChessPiece::Pawn));
        piece_locations.insert(Tile::B7, TeamedChessPiece(ChessTeam::Black, ChessPiece::Pawn));
        piece_locations.insert(Tile::C7, TeamedChessPiece(ChessTeam::Black, ChessPiece::Pawn));
        piece_locations.insert(Tile::D7, TeamedChessPiece(ChessTeam::Black, ChessPiece::Pawn));
        piece_locations.insert(Tile::E7, TeamedChessPiece(ChessTeam::Black, ChessPiece::Pawn));
        piece_locations.insert(Tile::F7, TeamedChessPiece(ChessTeam::Black, ChessPiece::Pawn));
        piece_locations.insert(Tile::G7, TeamedChessPiece(ChessTeam::Black, ChessPiece::Pawn));
        piece_locations.insert(Tile::H7, TeamedChessPiece(ChessTeam::Black, ChessPiece::Pawn));
    ...
    for line_res in stdin.lock().lines() {
        ...
        if first_character.unwrap() == '!' {
            ...
            match command.as_str() {
                ...
                "move_count" => {
                    println!("{} moves were made. {} to move.", game.move_count(), "White");
                }
                "test" => {
        ...
        } else { // This should be a chess move
