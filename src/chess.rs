...
impl Board {
    ...
    pub fn get_legal_moves_of_piece_in_tile(&self, tile: Tile, last_move: Option<Move>) -> Option<Vec<Coord>> {
    ...
    pub fn is_tile_attacked_by(&self, team: ChessTeam, tile: Tile, last_move: Option<Move>) -> bool {
